    ...
    <footer className="border-t border-slate-200 bg-slate-50 mt-auto relative overflow-hidden">
      ...
      <div className="section-container py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-heading font-semibold text-sm text-blue-700 mb-4 uppercase tracking-widest">Quick Links</h3>
          ...
          {/* Contact */}
          <div>
            <h3 className="font-heading font-semibold text-sm text-blue-700 mb-4 uppercase tracking-widest">Contact</h3>
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-sm text-slate-600">
                <MapPin className="w-4 h-4 mt-0.5 text-blue-500 flex-shrink-0" />
                <span>Nehru Nagar, Thirumalayampalayam, Coimbatore - 641105</span>
              </li>
              <li className="flex items-center gap-3 text-sm text-slate-600">
                <Mail className="w-4 h-4 text-blue-500 flex-shrink-0" />
                <a href="mailto:hackspark26@niitm.ac.in" className="hover:text-blue-700 transition-colors">
        ...
        <div className="mt-10 pt-6 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-slate-400 flex items-center gap-1 font-mono tracking-wider">
